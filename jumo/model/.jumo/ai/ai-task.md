...
当前选中：file `crates/wf-cep/src/cep/eval/cmp.rs`

目标质量信息（任务开始前采集，来自 `/Users/zuowenjian/devspace/rust/wfusion/wp-reactor/jumo/model/jumo-layout/code-quality.json`）：
...
1. 完成改动后重算报告，命令必须与下面完全一致（写入 Studio 正在读取的同一份报告，否则界面不会更新）：
   jumo-code code-quality /Users/zuowenjian/devspace/rust/wfusion/wp-reactor --out /Users/zuowenjian/devspace/rust/wfusion/wp-reactor/jumo/model/jumo-layout/code-quality.json
