...
> 状态：已归档（push 被 pull 模型替代，见 `window-actor-pull-model.md`）·
> [window-push-consumer-model.md](archive/window-push-consumer-model.md)
...
竞争。详见 [window-push-consumer-model.md](archive/window-push-consumer-model.md)。
