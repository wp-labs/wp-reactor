...
use wf_lang::ast::{
    CmpOp, CloseTrigger, ContractBlock, ExpectStmt, Expr, FieldAssign, GivenStmt, HitAssert,
};
...
pub fn run_contract(
    ...
    let close_trigger = contract
        .options
        .as_ref()
        .and_then(|o| o.close_trigger);
...
fn validate_hit_assert(
    ...
    match assert {
        ...
        HitAssert::Field { name, cmp, value: _ } => {
