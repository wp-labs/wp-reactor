...
fn join_asof_picks_latest_before_event_time() {
    ...
    let matched = MatchedContext {
        ...
        event_first_time_nanos: event_time,
        event_last_time_nanos: event_time,
        first_match_time_nanos: None,
        evidence_first_time_nanos: event_time,
        evidence_last_time_nanos: event_time,
...
fn join_asof_no_timestamp_support_skips() {
    ...
    let matched = MatchedContext {
        ...
        event_last_time_nanos: 1_000_000_000,
        first_match_time_nanos: None,
        evidence_first_time_nanos: 1_000_000_000,
        evidence_last_time_nanos: 1_000_000_000,
